    ...
    <Segment.Group>
      <Segment>
        <Grid>
          ...
          <Grid.Column width={8}>
            <Header>lupita - minister of culture</Header>
      ...
      <Segment>
        <Header>george - chief of operations</Header>
      ...
      <Segment>
        <Header>sami - chat witch</Header>
        <p>chat witch</p>
      </Segment>
      <Segment>
        <Header>davr - user interface tester</Header>
        <p>cyborg lab</p>
      </Segment>
      <Segment>
        <Header>jakk - trends analyst</Header>
        <p>lost child of the internet</p>
      </Segment>
      <Segment>
        <Header>pedr - blockchain researcher</Header>
        <p>bank boy</p>
      </Segment>
      <Segment>
        <Header>leila</Header>
